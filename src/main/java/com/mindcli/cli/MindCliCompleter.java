...
import com.mindcli.mcp.mention.AtMentionCompleter;
...
final class MindCliCompleter implements Completer {
    private final Supplier<List<McpResourceDescriptor>> resourceSupplier;
    private final Supplier<List<Skill>> skillSupplier;

    MindCliCompleter(Supplier<List<McpResourceDescriptor>> resourceSupplier) {
