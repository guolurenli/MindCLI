...
import com.mindcli.app.wechat.IlinkClient;
import com.mindcli.app.wechat.WechatAccount;
import com.mindcli.app.wechat.WechatAccountStore;
import com.mindcli.app.wechat.WechatLoginResult;
import com.mindcli.app.wechat.WechatMessageLoop;
import com.mindcli.app.wechat.WechatQrLogin;
...
public final class WechatCliCommandHandler {
    ...
    static WechatAccount setupWechatAccount(LineReader lineReader, Renderer renderer, PrintStream out) {
        try {
            ...
            com.mindcli.app.wechat.TerminalQrRenderer.print(out, qr.qrcodeUrl());
