...
import com.mindcli.capability.mcp.mention.AtMentionCompleter;
...
public final class MindCliCompleter implements Completer {
    private final Supplier<List<McpResourceDescriptor>> resourceSupplier;
    private final Supplier<List<Skill>> skillSupplier;

    public MindCliCompleter(Supplier<List<McpResourceDescriptor>> resourceSupplier) {
