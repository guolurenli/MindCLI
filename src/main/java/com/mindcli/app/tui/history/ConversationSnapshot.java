package com.mindcli.app.tui.history;
...
public class ConversationSnapshot {
    ...
    private static final Path HISTORY_DIR = Path.of(System.getProperty("user.home"), ".mindcli", "history");
