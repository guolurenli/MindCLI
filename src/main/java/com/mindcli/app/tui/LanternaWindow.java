...
public final class LanternaWindow {
     ...
     */
    public LanternaWindow(MindCliConfig config, LlmClient llmClient) throws IOException {
        ...
        this.mainWindow = new BasicWindow("MindCLI v16.0.0");
    ...
    public MindCliConfig getConfig() {
        return config;
    }
}
