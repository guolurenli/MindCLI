...
import com.mindcli.render.inline.TerminalCapabilities;
 ...
 *   <li>兼容：{@code MINDCLI_TUI=true} → 等价 {@code lanterna}，打 deprecation 提示</li>
 * </ul>
 *
...
public final class RendererFactory {
    ...
    public static Mode resolveMode() {
        ...
        // 兼容旧 MINDCLI_TUI=true → lanterna
        String legacyTui = System.getenv("MINDCLI_TUI");
        if (legacyTui != null && Boolean.parseBoolean(legacyTui.trim())) {
            System.err.println("⚠️ MINDCLI_TUI=true 已废弃，请改用 MINDCLI_RENDERER=lanterna");
