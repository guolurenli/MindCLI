...
class CodeRetrieverTest {
    ...
    private static final String TEST_PROJECT = "/tmp/mindcli-code-retriever";
    private VectorStore store;

    @BeforeEach
    void setUp() throws Exception {
        System.setProperty("mindcli.rag.dir", "/tmp/mindcli-test-rag-retriever");
